...
const contents = [['01', 'Notre histoire', '03', 'story'], ['02', 'Crêpe Banana Lover', '04', 'banana'], ['03', 'Choco Fondant Mini', '05', 'mini'], ['04', 'Choco Fondant Moyenne', '06', 'medium'], ['05', 'Crêpe Fraise Délice', '07', 'strawberry'], ['06', 'Comment commander', '08', 'steps'], ['07', 'Nos engagements', '09', 'engagements'], ['08', 'Nos formules événements', '10', 'events'], ['09', 'Nous commander', '11', 'closing']]
...
app.innerHTML = homeTemplate.replace('{{COVER_VISUAL}}', visual('/images/product2.jpeg')).replace('{{CONTENTS}}', contentsMarkup).replace('{{PRODUCTS}}', products.map(productMarkup).join('')).replace('{{STEPS}}', stepsMarkup).replace('{{ENGAGEMENTS}}', engagementsMarkup).replace('{{EVENTS}}', eventsMarkup).replace('{{CLOSING_VISUAL}}', visual('/images/product2.jpeg'))
